...
var ano = function(arr) {
 for (var i = 0; i < arr.length; i++)
  {
res.push(arr[i][0].toUpperCase() + arr[i].substr(1));
 }
 return res;
}
console.log(ano(arr));
...
const sum = num.reduce((acc,iteam)=>acc+iteam);
console.log(sum);
